namespace MainUI.LogicalConfiguration.Instrument.Forms
{
    partial class FrmCommandEditor : UIForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            mainLayout.Controls.Add(lblParseRules, 0, 6);
            mainLayout.Controls.Add(grpParseRules, 1, 6);
            mainLayout.Controls.Add(panelButtons, 0, 7);
            ...
            txtRequestTemplate.Watermark = "如: MEAS:VOLT:DC? ";
            // 
            // txtSuccessIndicator
            // 
            ...
            toolbarRules.Location = new Point(0, 0);
            ...
            dgvParseRules.Location = new Point(0, 35);
            ...
            dgvParseRules.RowTemplate.Height = 30;
            dgvParseRules.RowTemplate.ReadOnly = true;
            dgvParseRules.SelectedIndex = -1;
            dgvParseRules.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dgvParseRules.Size = new Size(710, 325);
            dgvParseRules.StripeOddColor = Color.FromArgb(235, 243, 255);
            dgvParseRules.TabIndex = 0;
            // 
            // grpParseRules
            // 
            grpParseRules.BackColor = Color.Transparent;
            ...
            grpParseRules.ForeColor = Color.FromArgb(48, 48, 48);
            grpParseRules.Location = new Point(119, 320);
            ...
            grpParseRules.Size = new Size(710, 360);
        ...
        private UIComboBox cboCommandType;
        private Label lblDataType;
        private UIComboBox cboDataType;
        private Label lblTimeout;
        private UITextBox txtTimeout;
        private Label lblWaitResponse;
        private UICheckBox chkWaitForResponse;
        private Label lblRequestTemplate;
        private UITextBox txtRequestTemplate;
        private Label lblSuccessIndicator;
        private UITextBox txtSuccessIndicator;
        private Label lblFailureIndicator;
        private UITextBox txtFailureIndicator;
        private Label lblDescription;
        private UITextBox txtDescription;
        private UISymbolButton btnOk;
        private UISymbolButton btnCancel;
        private Label lblParseRules;
        private UILine grpParseRules;
        private UIDataGridView dgvParseRules;
        private FlowLayoutPanel toolbarRules;
        private UISymbolButton btnAddRule;
        private UISymbolButton btnDeleteRule;
    }
}